  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="bg-white rounded-lg border">
        <div className="flex flex-wrap gap-4 items-center p-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-gray-100">
          {/* Search */}
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white"
            />
          </div>
          ...
          <div className="relative">
            ...
            <select
              ...
              className="pl-10 pr-8 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white appearance-none cursor-pointer"
            >
